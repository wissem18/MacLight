...
from net.net import PolicyNet, ValueNet, GATBlock, TemporalEncoder, DynamicPredictor, SATBlock
...
if __name__ == '__main__':
    ...
    if len(set(state_dim)) == 1:
        ...
        args.model_name = 'Ours_SAT_temporal_encoder'
    ...
    params  = list(sat.parameters()) + list(temp_enc.parameters()) + list(predictor.parameters())
    ...
    for seed in trange(args.seed[0], args.seed[-1] + 1, mininterval=40, ncols=70):
        ...
        return_list, train_time = train_ours_agent(env, marl, agent_name, sat,temp_enc, predictor,optimizer,scheduler,  args.writer,
