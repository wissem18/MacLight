...
if __name__ == '__main__':
    ...
    alg_args['lmbda'] = 0.95  # Used to adjust the coefficient of the converted reward when calculating the advantage
    alg_args['gamma'] = 0.99  # Temporal difference learning rate, also used as one of the coefficients for discounting rewards
    ...
    for seed in trange(args.seed[0], args.seed[-1] + 1, mininterval=40, ncols=70):
        ...
        magent = MARLWrap('CTDE', MAPPO, alg_args, PolicyNet, ValueNet,
                          state_dim, hidden_dim, action_dim)
        return_list, train_time = train_MAPPO_agent(env, magent, agent_name, args.writer,
